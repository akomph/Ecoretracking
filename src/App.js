...
// <<! ------------------------------------------------------------------ !>>
// <<! สำคัญ: ให้นำค่า Config จากโปรเจกต์ Firebase ของคุณมาวางทับที่นี่โดยตรง !>>
...
// --- Collections ---
const dataCollectionName = `exam_results_v5`;
const configCollectionName = `config_v5`;
const usersCollectionName = `users_v5`;
